...
'''
tokens = [
    Token("TK_FUNCTION", 'def'),
    Token("TK_IDENTIFIER", 'sum'),
    Token("TK_OP", '('),
    Token("TK_DT_INTEGER", 'int'),
    Token("TK_IDENTIFIER", 'a'),
    Token("TK_COMMA", ','),
    Token("TK_DT_INTEGER", 'int'),
    Token("TK_IDENTIFIER", 'b'),
    Token("TK_CP", ')'),
    Token("TK_OK", '{'),
    ...
    Token("TK_OK", '{'),
    Token("TK_DT_INTEGER", 'int'),
    Token("TK_IDENTIFIER", 'x'),
    Token("TK_END", ';'),
    Token("TK_DT_INTEGER", 'int'),
    Token("TK_IDENTIFIER", 'y'),
    Token("TK_ASSIGNMENT", '='),
    Token("TK_INTEGER", '100'),
    Token("TK_END", ';'),
    Token("TK_PRINT", 'print'),
    Token("TK_OP", '('),
    Token("TK_INTEGER", '42'),
    ...
    Token("TK_PRINT", 'print'),
    Token("TK_OP", '('),
    Token("TK_STRING", 'Zero'),
    Token("TK_CP", ')'),
    Token("TK_END", ';'),
    Token("TK_CK", '}'),
    Token("TK_WHILE", 'while'),
    Token("TK_OP", '('),
    Token("TK_IDENTIFIER", 'condition'),
    Token("TK_LOGIC_GT", '>'),
    Token("TK_INTEGER", '0'),
    Token("TK_CP", ')'),
    Token("TK_OK", '{'),
